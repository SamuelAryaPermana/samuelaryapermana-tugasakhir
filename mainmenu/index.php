      ...
      <div class="jumbotron jumbotron-fluid">
        <div class="container">
          ...
          <h5 class="lead">Let's check your Body Mass Index, Daily Calories requirement,
            <br> and we will give you good advices for you!</h5>
        </div>
      </div>
      <!-- AKhir Jumbotron -->
      <div class="proses">
        ...
        <form class="justify-content-center " method="post">
          ...
          $maintain=array('1. Dont skip breakfast','2. Eat vegetables and foods that contain protein in normal portions','3. Light exercise');
          ?>
          <!-- result -->
